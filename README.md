...
1. 레포지토리를 `fork` 한다. (스터디 깃헙 첫 가입시에만) <br/>
2. 생성된 원격 저장소(본인 깃헙) 자신의 폴더에 날짜별 폴더를 생성한다. <br/> 폴더명은 매주의 스터디 날짜 (ex. 20240123) <br/>
3. 문제 풀이 후 자신의 원격 저장소(본인 깃헙) 날짜 폴더에 `push` 한다. <br/> 파일명은 "플랫폼 문제번호 문제이름.확장자" (ex. 백준 1041 주사위.cpp) <br/>
4. commit 컨벤션 양식을 지켜 커밋한다. <br/>
